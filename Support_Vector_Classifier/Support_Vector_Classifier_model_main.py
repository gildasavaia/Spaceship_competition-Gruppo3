...
def main():
    ...
    if scelta == "1":
        ...
        if train_path.exists() and test_path.exists():
            ...
            print(f"Errore: Assicurati che i file 'holdout_nn' esistano in {preprocessed_dir}")
    ...
    # Opzione 2: K-Fold Cross Validation.
        ...
        if not train_files:
            print(f"Errore: Assicurati che i file 'kfold_*_nn_train.csv' esistano in {preprocessed_dir}")
        else:
    ...
    # Opzione 3: Full Validation.
        ...
        if train_path.exists() and test_path.exists():
            ...
            print(f"Errore: Assicurati che i file 'full_nn' esistano in {preprocessed_dir}")
